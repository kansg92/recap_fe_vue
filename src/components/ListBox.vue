  ...
  <Listbox as="div" v-model="selected">
    ...
    <div class="relative">
      ...
      <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
        ...
        >
          <ListboxOption as="template" v-for="option in selectOption" :key="option.title" :value="option" v-slot="{ active, selected }">
...
const porps = defineProps(["selectOption"])



const selected = ref(porps.selectOption[0]);
</script>
