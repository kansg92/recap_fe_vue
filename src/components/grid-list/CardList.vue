<template>
  <div class="divide-y divide-gray-200 overflow-hidden rounded-lg sm:grid sm:grid-cols-3 sm:gap-px sm:divide-y-0">
    <div
      ...
      :class="[
        ...
        'group relative bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500 m-3 border',
      ]"
    >
      <div>
      ...
      <span class="pointer-events-none absolute right-6 top-6 text-gray-400 group-hover:text-gray-500" aria-hidden="true">
