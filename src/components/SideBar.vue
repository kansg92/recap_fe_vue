            ...
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2">
                <div class="flex h-16 shrink-0 items-center">
                  <a href="/"><img class="h-8 w-auto" src="@/assets/red_bottle_cap_aih.png" alt="Your Company" /></a>
                </div>
...
const navigation = [
  { name: "데일리리포트", href: "#", icon: HomeIcon, current: true },
  { name: "가계부", href: "#", icon: UsersIcon, current: false },
  { name: "습관노트", href: "#", icon: FolderIcon, current: false },
