<template>
  <div>
    <div class="sm:hidden">
      ...
      <select  v-model="selectedTab.name"  @change="()=>{setCurrent(tabs, selectedTab)}" class="block w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
